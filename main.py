...
class AlienInvasion:
    ...
    def _check_play_button(self, mouse_pos):
        """Stat a new game when the player click the play button."""
    ...
    def _create_fleet(self):
        ...
        # Determine the number of rows of aliens that fit on tje screen.
    ...
    def _check_fleet_edges(self):
        """Respond appropriately if any aliens have reached  am edge."""
        for alien in self.aliens.sprites():
